                ...
                <div className="flex-1 w-full relative">
                  ...
                  <div className="aspect-square md:aspect-[4/3] w-full rounded-[2rem] overflow-hidden rotate-2 hover:rotate-0 transition-transform duration-500 shadow-xl border-4 border-white dark:border-[#4a3629]">
                    <div
                      ...
                      style={{
                        backgroundImage: `url(${"https://lh3.googleusercontent.com/aida-public/AB6AXuCH3cpQdn_dCTmyEICQaDbk9RHI0TPh32s5uFmu7uT_3yMpZzZn253EYhJOeICdvPk6gec1O7lxqjk_fMkuVgI3-V7iqsZUZRmn7Jq-2eGEqPn5iLVyU6MUdCwjS7PbCu2v6r5ZZTfP4bHyhsxwd2zACdDlzd6Y7MITRto9jwHQjq2h3WXg7Ka9KHqbiOCwmTjWkrEC6IKn8-RSlASz4ooH-a2HSFdNC8BM4F4RSyYTW3NELI1wxl7vkQSk-cdsRcCmw506ZzJdNKo"})`,
                      }}
                    ></div>
                  </div>
